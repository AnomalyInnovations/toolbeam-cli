Below is the annotated version of the spec with the changes made. The complete spec is available [here](docs/examples/delete-movie.json). See the full list of options that Toolbeam uses [here](/#toolbeam-spec).
