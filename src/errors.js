...
export const ERR_ADD_INVALID_PARAM_ENUM = 'Invalid parameter option enum';
export const ERR_ADD_INVALID_NOTIFICATION_PERMISSION = 'Invalid notification permission';
